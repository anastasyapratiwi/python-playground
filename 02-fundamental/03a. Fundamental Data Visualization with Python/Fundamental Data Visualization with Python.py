# Profil Pemateri: Laksono Hari Wiwoho, Wakil Redaktur Pelaksana, Kompas.com
...
tabel = (pd.read_csv("https://dqlabcdn.xeratic.com/dqlab-dataset/usia_karyawan.csv")
...
# 1. Load Data & Scaling (Dibagi 1000 agar jadi satuan ribuan)
tabel = pd.read_csv("https://dqlabcdn.xeratic.com/dqlab-dataset/produktivitas_karyawan.csv", index_col="Bulan") / 1000

# 2. Setup Kanvas Grafik
...
# 3. Pengaturan Warna dan Ketebalan Garis (Karyawan E warna darkblue dan paling tebal)
...
# Pengaturan posisi teks agar tidak saling tumpang tindih (overlapping)
...
for i, item in enumerate(lp.get_lines()):
    ...
    lbl = item.get_label()  # Masuk ke dalam loop
    
    # Menambahkan label nama karyawan di ujung kanan garis (Desember)
    ...
    # Menambahkan label rata-rata (avg) di bawah nama karyawan
...
# 4. Menandai Titik Tertinggi Karyawan E (Spesial Data Storytelling)
...
# 5. Merapikan Axis Ticks dan Label (Mengambil 3 huruf pertama nama bulan, misal: Jan, Feb)
...
# 6. Menghilangkan Garis Frame Atas, Kanan, Bawah yang Mengganggu Visual
ax.spines["top"].set_color("none")
ax.spines["right"].set_color("none")
ax.spines["bottom"].set_color("none")
ax.get_legend().remove() # Hapus legend bawaan karena sudah di-annotate manual
