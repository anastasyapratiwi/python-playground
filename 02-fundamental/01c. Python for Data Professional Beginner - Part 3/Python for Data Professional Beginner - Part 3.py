...
# merepresentasikan Diriku dan Senja sebagai karyawan di suatu perusahaan X. Untuk merepresentasikan Diriku dan Senja, aku dapat membuat sebuah class yang nantinya akan mencakup properti-properti yang umumnya dimiliki oleh karyawan.
class Karyawan:
    pass

# Menciptakan objek (Diriku dan Senja) dari sebuah class
aksara = Karyawan()
senja = Karyawan()

# --- Tugas (tutorial sederhana untuk membantu memahami konsep OOP:) ---
...
# --- Tugas merepresentasikan instance attribute ---
# Definisikan class Karyawan
class Karyawan:
    nama_perusahaan = "ABC"
...
print(
    senja.nama + ", Usia: " + str(senja.usia) + ", Pendapatan " + str(senja.pendapatan)
)
...
# --- Tugas Praktek (penghitungan pembayaran fee karyawan lepas) ---
# Definisikan class Karyawan
class Karyawan:
    def __init__(self, nama, usia, pendapatan, insentif_lembur): 
        self.nama = nama
...
# --- Tugas Praktik (Inheritance + per divisi) ---
...
class Karyawan: 
    ...
    def __init__(self, nama, usia=21, pendapatan=5000000): #sebagai default
        self.nama = nama
        self.usia = usia 
        self.pendapatan = pendapatan 
        self.pendapatan_tambahan = 0
...
karyawan_baru1 = Karyawan('Budi') # Budi ini default karena usianya 21 dan gajinya 5000000
print(karyawan_baru1.nama)
print(karyawan_baru1.usia)
print(karyawan_baru1.total_pendapatan())

# Karyawan baru ke-2 yang bernama Didi, umur 25
karyawan_baru2 = Karyawan('Didi', 25) # Didi ini ditulis begini karena gajinya sama kayak Budi tapi umurnya 25
print(karyawan_baru2.nama)
print(karyawan_baru2.usia)
print(karyawan_baru2.total_pendapatan())

# Karyawan baru ke-3 yang bernama Hadi, pendapatan 8000000
karyawan_baru3 = Karyawan('Hadi', pendapatan=8000000) # Hadi ditulis gini karena umurnya sama kayak Budi tapi gajinya 8000000
